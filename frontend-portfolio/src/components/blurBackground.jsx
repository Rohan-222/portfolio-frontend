...
const BlurBackground = () => {
  return (
    <div className="fixed top-0 w-full h-full overflow-hidden -z-10 pointer-events-none flex justify-center items-center filter blur-[100px] opacity-70">
      ...
      <motion.div className="bg-pink-500 w-[350px] h-[250px] rounded-full absolute" variants={circleVariants} animate="animate6" />
    </div>
  );
};
